...
public class BusinessFragment extends Fragment implements RecyclerViewInterface{
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        Query schoolQuery = databaseReference.orderByChild("school").equalTo("Science and applied technology");
        Query postQuery = databaseReference.orderByChild("post").equalTo("Business");
