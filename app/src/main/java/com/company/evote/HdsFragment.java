...
public class HdsFragment extends Fragment implements RecyclerViewInterface{
    ...
    int []arr = { R.drawable.img1, R.drawable.img2, R.drawable.img3,
            R.drawable.img5, R.drawable.img6, R.drawable.img6,
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_hds, container, false);
        ...
        Query schoolQuery = databaseReference.orderByChild("school").equalTo("Hds");
